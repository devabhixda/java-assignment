...
class Employee{
	...
	double salaryOfEmployee(Employee employee) {
		...
		for(int i=1; i<=employee.getDifferenceInYear();i++) {
			...
			System.out.println("Enter no. of leaves taken from 1st Jan - 31st Dec of year: "+i);
	...
	Employee(){
		...
		setPhoneNumber(keyboard.next());
		
		System.out.print("Enter Date of Joining(in DD/MM/YYYY)- ");
		String doj=keyboard.next();
		String [] dateParts = doj.split("/");
		...
		switch(employee.getSection()) {
			case 1:	
					switch(employee.getTitle()) {
						case 1:	
							HR hr = new HR();
							System.out.println("New Salary: "+hr.salaryOfEmployee(employee)+"Lakhs per Month");
							break;
						case 2:	
							Technology technology = new Technology();
							System.out.println("New Salary: "+technology.salaryOfEmployee(employee)+"Lakhs per Month");
							break;
					}
					break;
			case 2:
					...
					case 1:	
						...
						System.out.println("New Salary: "+developer.salaryOfEmployee(employee)+"Lakhs per Month");
						break;
					case 2:	
						Tester tester = new Tester();
						System.out.println("New Salary: "+tester.salaryOfEmployee(employee)+"Lakhs per Month");
						break;
					case 3:
						Architect architect = new Architect();
						System.out.println("New Salary: "+architect.salaryOfEmployee(employee)+"Lakhs per Month");
						break;
					}
					break;
			}
